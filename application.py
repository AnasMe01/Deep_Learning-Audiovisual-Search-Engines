...
label_names = ['Plane', 'Car', 'ird', 'Cat', 'Deer', 'Dog', 'Frog', 'Horse', 'Boat', 'Truck']
...
def rechercher_par_audio():
    ...
    try:
        ...
        label_resultat = "Unable to connect to Google Speech Recognition service; {0}".format(e)
...
def index():
    if request.method == 'POST':
        if 'image' in request.files:
            ...
            return render_template('index.html', image_path=image_path, predicted_class=predicted_class)
